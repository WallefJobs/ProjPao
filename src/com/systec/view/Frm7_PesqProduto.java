 ...
 * @author aluno
 */
public class Frm7_PesqProduto extends javax.swing.JDialog {

    PreparedStatement stmt = null;
    ResultSet rs = null;
    

    CadasProduto serv = new CadasProduto();

    public Frm7_PesqProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void Pesquisar() {
        ...
        String sql = "SELECT id_produtos, nome, valor, qtd FROM tb_produtos WHERE nome LIKE ?";
        try {
            ...
            colunas();
            while (rs.next()) {
                modelo.addRow(new Object[]{rs.getObject(1), rs.getObject(2),rs.getObject(3), rs.getObject(4)});
            }
            tblProduto.setModel(modelo);
            tblProduto.getColumnModel().getColumn(0).setMaxWidth(1000);
            tblProduto.getColumnModel().getColumn(0).setMinWidth(50);
            tblProduto.getColumnModel().getColumn(1).setMinWidth(50);
            tblProduto.getColumnModel().getColumn(2).setMinWidth(50);
    ...
    private void PreencherTabela() {
        Connection conn = ConnectionFactory.getConnection();
        String sql = "SELECT pro.id_produtos , pro.nome, pro.valor, pro.qtd  FROM tb_produtos pro";
        try {
            stmt = conn.prepareStatement(sql);
            rs = stmt.executeQuery();
            colunas();
    ...
    private void setCampos() {
        ...
        serv.setId_produtos(Integer.parseInt(tblProduto.getValueAt(linha, 0).toString()));
    }
    ...
    private void initComponents() {
        ...
        tblProduto.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        tblProduto.setEditingColumn(0);
        tblProduto.setEditingRow(0);
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        if (tblProduto.getSelectedRow() >= 0) {
            setCampos();
            Frm8_CadasProduto.linha = tblProduto.getSelectedRow() + 1;
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Não há nenhuma Produto selecionada!", "Atenção", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm7_PesqProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Frm7_PesqProduto dialog = new Frm7_PesqProduto(new javax.swing.JFrame(), true);
